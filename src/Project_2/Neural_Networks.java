...
public class Neural_Networks {
    ...
    public void Perceptron_initialization(){
     ...
     w1=-0.1;//Double.parseDouble(d.format((Math.random() *(0.5 - 0.5 +1) + -0.5)));
     w2=0.1;//Double.parseDouble(d.format((Math.random() *(0.5 - 0.5 +1) + -0.5)));
     threshold=0.2;//Double.parseDouble(d.format(Math.random() *(0.5 - 0.5 +1) + -0.5));
    }
